...
describe('AlignElementsTool', () => {
    ...
    describe('Parameter Validation', () => {
        ...
        it('should return error when less than 2 elements provided', async () => {
            ...
            expect(result.error).toBe(
                'At least two elements are required for alignment',
            );
        });
    });
    ...
    describe('Horizontal Alignment', () => {
        ...
        it('should center align elements horizontally', async () => {
            ...
            const firstCenter =
                elements[0].position.x + elements[0].size.width / 2;
            elements.forEach((el) => {
    ...
    describe('Distribution', () => {
        ...
        it('should distribute elements horizontally', async () => {
            ...
            const gap1 =
                sortedElements[1].position.x -
                (sortedElements[0].position.x + sortedElements[0].size.width);
            const gap2 =
                sortedElements[2].position.x -
                (sortedElements[1].position.x + sortedElements[1].size.width);
        ...
        it('should require at least 3 elements for distribution', async () => {
            ...
            expect(result.success).toBe(false);
            expect(result.error).toBe(
                'At least three elements are required for distribution',
            );
        });
    });
    ...
    describe('No Changes Needed', () => {
        it('should return success when elements are already aligned', async () => {
            ...
            expect(result.data.message).toBe(
                'Elements are already aligned as requested',
            );
        });
    });
});
