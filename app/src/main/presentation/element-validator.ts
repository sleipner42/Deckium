...
export class ElementValidator {
    ...
    static async checkOverlapPrecise(
        ...
        try {
            ...
            if (
                domResult.hasOverlap &&
                domResult.overlappingElements.length > 0
            ) {
                suggestedPosition =
                    ElementValidator.suggestNewPositionFromDOMElements(
    ...
    static async checkElementOverlap(
        ...
        try {
            ...
            const domResult =
                await textMeasurementService.checkOverlapWithElementId(
                    elementId,
                    padding,
                );
    ...
    private static suggestNewPositionFromDOMElements(
        ...
        console.log(
            'DOM-based: Using grid-based position suggestion as fallback',
        );
