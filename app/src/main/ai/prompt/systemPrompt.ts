...
- Prefer the compound component tools over hand-assembling shape + text: createHeaderBar (slide title + accent line at standard margins), createCard (surface panel with title/body inside), createStatCard (big accent number + muted label, use rows of 3-4 for metrics), createTakeawayBar (bottom message bar). They handle padding, centering, and z-index; pass your design language's colors.
