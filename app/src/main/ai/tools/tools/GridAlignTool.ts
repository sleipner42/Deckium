        ...
        elementsToAlign.forEach((element) => {
            ...
            switch (snapMode) {
                case 'top-left':
                    ...
                    snapX = this.snapToGrid(
                        element.position.x,
                        cellSize,
                        originX,
                    );
                    snapY = this.snapToGrid(
                        element.position.y,
                        cellSize,
                        originY,
                    );
                ...
                case 'center': {
                    ...
                    const snappedCenterX = this.snapToGrid(
                        centerX,
                        cellSize,
                        originX,
                    );
                    const snappedCenterY = this.snapToGrid(
                        centerY,
                        cellSize,
                        originY,
                    );
                ...
                case 'nearest-corner': {
                    ...
                    corners.forEach((corner, index) => {
                        const snappedX = this.snapToGrid(
                            corner.x,
                            cellSize,
                            originX,
                        );
                        const snappedY = this.snapToGrid(
                            corner.y,
                            cellSize,
                            originY,
                        );
