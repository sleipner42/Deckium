  ...
  protected async executeImpl(
    ...
    switch (alignType) {
      ...
      case 'center-horizontal': {
        ...
        if (referenceElement) {
          centerX =
            referenceElement.position.x + referenceElement.size.width / 2;
        } else {
      ...
      case 'center-vertical': {
        ...
        if (referenceElement) {
          centerY =
            referenceElement.position.y + referenceElement.size.height / 2;
        } else {
      ...
      case 'distribute-horizontal': {
        ...
        if (referenceElement) {
          ...
          const rightmost =
            elementsSortedHorizontal[elementsSortedHorizontal.length - 1];
      ...
      case 'distribute-vertical': {
        ...
        if (referenceElement) {
          ...
          const bottommost =
            elementsSortedVertical[elementsSortedVertical.length - 1];
