...
const DOWNLOAD_URLS = {
	...
	linux: `${AZURE_BASE_URL}/linux/Deckium-1.0.0.AppImage`,
};
				...
				<main className="py-20">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-gray-400 max-w-2xl mx-auto">
							Get Deckium for your platform and start creating AI-powered
							presentations with human control. Choose your operating system
							below.
						</p>
					</div>
